...
public class AuctionController extends AnchorPane {
	...
	@FXML private void showDefintions(ActionEvent event) {
		...
		about.setContentText(
			...
			"Campaign: An effort by the marketing agency to gain exposure for a clientâ€™s website by participating in a range of ad auctions offered by different providers and networks. Bid amounts, keywords and other variables will be tailored to the clientâ€™s needs.\n" + 
